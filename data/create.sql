...
ALTER TABLE Usuarios ADD COLUMN fecha_nacimiento TEXT NOT NULL DEFAULT '1970-01-01';
ALTER TABLE eventos ADD COLUMN edad_minima INTEGER NOT NULL DEFAULT 0;
COMMIT;
